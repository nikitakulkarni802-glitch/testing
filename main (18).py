...
if not st.session_state.logged_in:
    ...
    # ====================== FORECAST TAB (Updated for Non-Technical Users) ======================
    with tab_forecast:
        ...
        if hist.empty:
            ...
            if level in group_map:
                ...
                st.caption(f"These are the {level.lower()}s that had the highest numbers in the past. The same method is applied to each one separately.")
